document.addEventListener("DOMContentLoaded", () => {
    const projects = [
        { name: "multi-protocol-analyzer", url: "https://hexpad.github.io/uart-spi-i2c-analyzer/", category: "Microcontrollers", description: "C++ based UART, SPI, and I2C protocol analyzer with ESP32" },
