document.addEventListener("DOMContentLoaded", () => {
    const projects = [
        { name: "cfar-target-detector", url: "https://hexpad.github.io/cfar-target-detector/", category: "Signal Processing", description: "Simple C++ implementation of CFAR target detection for radar signal processing" },
